    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('pending', 'Order placed'), ('processing', 'Product packaging'), ('shipped', 'Ready for shipment'), ('trucking', 'On the way'), ('arrived', 'Dropped in the delivery station'), ('delivered', 'Delivered'), ('out of stock', 'Out of stock')], default='pending', max_length=20)),
